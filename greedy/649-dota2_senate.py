...
#        are all from the same party, he can announce the victory and decide on the change
#        in the game.
#
#Given a string senate representing each senator's party belonging. The character 'R' and 'D'
#represent the Radiant party and the Dire party. Then if there are n senators, the size of
...
class Solution:
    def predictPartyVictory(self, senate: str) -> str:
        ...
        while radiant and dire:
            ...
            # The winner goes to next round (add n to maintain order)
            if r_idx < d_idx:
