...
class Solution:
    def canBeEqual(self, target: List[int], arr: List[int]) -> bool:
        """
        Key insight: any permutation is achievable through reversals.
        (Like bubble sort - adjacent swaps = reversal of size 2)
        So just check if both arrays have same elements.
        """
