...
#stk.push(4);                          // stack still [1, 2, 3], Don't add another elements as size is 4
...
class CustomStack:
    """
    Lazy increment: Store increments separately, apply on pop.
    ...
    def __init__(self, maxSize: int):
        ...
        self.stack = []
        self.inc = []  # inc[i] = increment to apply to elements 0..i when popping
    ...
    def pop(self) -> int:
        ...
        result = self.stack.pop() + self.inc[idx]

        # Propagate increment to next element
        if idx > 0:
