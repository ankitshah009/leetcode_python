...
#the next revision being revision 1, and so on. For example 2.5.33 and 0.1 are valid version
#numbers.
#
...
#then treat the revision as 0. For example, version 1.0 is less than version 1.1 because
