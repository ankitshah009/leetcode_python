...
#    If there are still cards in the deck then put the next top card of the deck at the
#        bottom of the deck.
...
#Explanation:
#We get the deck in the order [17,13,11,2,3,5,7] (this notation means that 17 is the top of
#the deck), and reorder it.
...
class Solution:
    def deckRevealedIncreasing(self, deck: List[int]) -> List[int]:
        ...
        for card in reversed(deck):
            if result:
                # Move bottom card to top, then add new card
