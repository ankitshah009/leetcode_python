...
#from that day and going backward) for which the stock price was less than or equal to the
#price of that day.
#
...
#stockSpanner.next(60);  // return 1
#stockSpanner.next(75);  // return 4, because the last 4 prices (including today's) were <= 75.
