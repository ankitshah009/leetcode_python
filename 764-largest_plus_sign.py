...
#Intuition
#
#How can we improve our bruteforce? One way is to try to speed up the inner loop involving k, the order of the candidate plus sign. If we knew the longest possible arm length Lu,Ll,Ld,LrL_u, L_l, L_d, L_rLu​,Ll​,Ld​,Lr​ in each direction from a center, we could know the order min⁡(Lu,Ll,Ld,Lr)\min(L_u, L_l, L_d, L_r)min(Lu​,Ll​,Ld​,Lr​) of a plus sign at that center. We could find these lengths separately using dynamic programming.
#
#Algorithm
#
