...
#  becomes [0,1].
#- Pick the child with the happiness value == 1. The happiness value of the remaining children
...
#  becomes [0,0,0].
#- Pick the child with the happiness value == 0. The happiness value of the remaining children
#  becomes [0,0].
#The sum of the happiness values of the selected children is 1 + 0 = 1.
#
#Example 3:
#Input: happiness = [2,3,4,5], k = 2
#Output: 7
#Explanation: We can pick 2 children in the following way:
...
#- Pick the child with the happiness value == 3. The happiness value of the remaining children
#  becomes [0,1].
#The sum of the happiness values of the selected children is 5 + 3 - 1 = 7.
#
#Constraints:
...
class Solution:
    def maximumHappinessSum(self, happiness: List[int], k: int) -> int:
        ...
        for i in range(k):
            # Each turn reduces happiness by i (number of previous selections)
